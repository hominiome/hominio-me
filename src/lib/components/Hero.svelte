...
<div class="relative text-center mb-16 h-[85vh] flex flex-col justify-center" style="width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; margin-top: 0 !important; padding-top: 0 !important; top: 0; transform: translateY(0);">
  <!-- Background Image -->
  <div class="absolute top-0 left-0 right-0 overflow-hidden z-0 h-[85vh] m-0 p-0" style="top: 0; margin-top: 0; padding-top: 0;">
    <img 
      src="/hero.jpg" 
      alt="Hero Background" 
  ...
  <!-- Content Layer -->
  <div class="relative z-10 px-1.5 md:px-4">
