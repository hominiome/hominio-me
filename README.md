...
**DNS Setup:**
- DNS-level redirect handles `www.hominio.me` → `hominio.me` (301 permanent redirect)
- See `docs/deployment/DNS_REDIRECT_SETUP.md` for DNS configuration instructions
- Code always uses non-www domain (`hominio.me`)
